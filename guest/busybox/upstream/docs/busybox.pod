...
Currently available applets include:
	...
	apk, ash, busybox, cat, clear, cp, cut, date, echo, env, false,
	grep, head, hexdump, ls, mkdir, mv, printf, pwd, rm, rmdir, sed,
	seq, sh, sort, tail, test, touch, tr, true, uniq, wc
...
apk add|del|list|info|search|update|upgrade|sync-world [PKG]...
