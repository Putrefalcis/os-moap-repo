...
"CONFIG_SYSROOT=\"\"\n"
"CONFIG_EXTRA_CFLAGS=\"--target=wasm32-wasip1 --sysroot=/home/dkay/src/sl-LSL/OS-MOAP/build/wasi-sdk/share/wasi-sysroot -I/home/dkay/src/sl-LSL/OS-MOAP/guest/busybox/wasi-stubs/include -D_WASI_EMULATED_SIGNAL -D_WASI_EMULATED_PROCESS_CLOCKS -D_WASI_EMULATED_GETPID -Wno-implicit-function-declaration -include /home/dkay/src/sl-LSL/OS-MOAP/guest/busybox/wasi-stubs/include/_sockcompat.h -D_WASI_EMULATED_MMAN -mllvm -wasm-enable-sjlj -include /home/dkay/src/sl-LSL/OS-MOAP/guest/busybox/wasi-stubs/include/_bbcompat.h\"\n"
"CONFIG_EXTRA_LDFLAGS=\"-lwasi-emulated-mman -lwasi-emulated-signal -lwasi-emulated-process-clocks -lwasi-emulated-getpid -mexec-model=command -Wl,-u,__main_argc_argv -L/home/dkay/src/sl-LSL/OS-MOAP/guest/busybox/wasi-compat -lwasicompat -lsetjmp -Wl,--wrap,fcntl\"\n"
"CONFIG_EXTRA_LDLIBS=\"\"\n"
