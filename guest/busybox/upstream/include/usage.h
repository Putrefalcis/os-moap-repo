...
#define apk_trivial_usage \
       "add|del|list|info|search|update|upgrade|sync-world [PKG]..." \

#define apk_full_usage "\n\n" \
       "Manage packages from the prim's notecard media + /etc/apk/repositories\n" \
